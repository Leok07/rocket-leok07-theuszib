...
export const TIER_STYLES: Record<FutCardTier, TierStyleConfig> = {
  ...
  // 4. TWO-WAY TITAN (Híbrido Striker + Guardian: Carmesim Laser e Cobalto Safira)
  two_way_titan: {
    cardBg: 'from-[#2e0918] via-[#080d1d] to-[#0a1e3d]',
    outerBorder: 'border-sky-400',
    borderGlow: 'shadow-[0_0_35px_rgba(56,189,248,0.45),0_0_20px_rgba(244,63,94,0.4)]',
    innerBorder: 'border-sky-400/40',
    ovrText: 'text-white drop-shadow-[0_2px_12px_rgba(56,189,248,0.9)]',
    posText: 'text-[#fecdd3]',
    statLabel: 'text-sky-300 font-black',
    statValue: 'text-white font-black',
    tierLabel: 'TWO-WAY TITAN',
    headerIconColor: 'text-sky-300',
    crestBorder: 'border-sky-400/80 shadow-[0_0_20px_rgba(56,189,248,0.35)]',
    crestBg: 'from-rose-950/70 via-slate-950/90 to-blue-950/70',
    nameplateBorder: 'border-sky-400/40 bg-gradient-to-r from-rose-950/60 via-slate-950/80 to-blue-950/60',
    editionBadge: 'bg-sky-950/90 border-sky-400/80 text-sky-200',
    accentGradient: 'from-rose-500 via-white to-sky-400',
    foilGlow: 'rgba(56, 189, 248, 0.45)',
    shieldBorderGradient: 'from-[#38bdf8] via-[#ffffff] to-[#f43f5e]',
  ...
  // 7. TOTW GUARDIAN (Híbrido TOTW + Guardian: Ouro Imperial e Cobalto Safira)
  totw_guardian: {
    cardBg: 'from-[#281a07] via-[#081324] to-[#0c2242]',
    outerBorder: 'border-amber-400',
    borderGlow: 'shadow-[0_0_35px_rgba(245,158,11,0.5),inset_0_0_20px_rgba(56,189,248,0.25)]',
    innerBorder: 'border-amber-400/40',
    ovrText: 'text-[#fef08a] drop-shadow-[0_2px_12px_rgba(245,158,11,0.9)]',
    posText: 'text-sky-200',
    statLabel: 'text-amber-300 font-black',
    statValue: 'text-white font-black',
    tierLabel: 'TOTW GUARDIAN',
    headerIconColor: 'text-amber-400',
    crestBorder: 'border-amber-400/80 shadow-[0_0_20px_rgba(245,158,11,0.35)]',
    crestBg: 'from-yellow-950/60 via-slate-950/90 to-blue-950/60',
    nameplateBorder: 'border-amber-400/40 bg-gradient-to-r from-yellow-950/60 via-slate-950/80 to-blue-950/60',
    editionBadge: 'bg-amber-950/90 border-amber-400/80 text-amber-200',
    accentGradient: 'from-yellow-400 via-sky-300 to-blue-500',
    foilGlow: 'rgba(245, 158, 11, 0.45)',
    shieldBorderGradient: 'from-[#fbbf24] via-[#38bdf8] to-[#1d4ed8]',
    auraColor: 'rgba(245, 158, 11, 0.35)',
  },
  ...
  // 10. GUARDIAN (Especialista Defensivo: Cobalto Safira e Ciano Neon)
  guardian: {
    cardBg: 'from-[#0a182d] via-[#040a17] to-[#0d274c]',
    outerBorder: 'border-sky-400',
    borderGlow: 'shadow-[0_0_32px_rgba(56,189,248,0.45),inset_0_0_20px_rgba(30,58,138,0.25)]',
    innerBorder: 'border-sky-400/35',
    ovrText: 'text-[#e0f2fe] drop-shadow-[0_2px_12px_rgba(56,189,248,0.85)]',
    posText: 'text-sky-300',
    statLabel: 'text-sky-300 font-black',
    statValue: 'text-white font-black',
    tierLabel: 'GUARDIÃO DEFENSIVO',
    headerIconColor: 'text-sky-400',
    crestBorder: 'border-sky-400/80 shadow-[0_0_20px_rgba(56,189,248,0.35)]',
    crestBg: 'from-blue-950/70 via-slate-950/90 to-blue-950/70',
    nameplateBorder: 'border-sky-400/40 bg-gradient-to-r from-blue-950/60 via-slate-950/80 to-blue-950/60',
    editionBadge: 'bg-blue-950/90 border-sky-400/70 text-sky-200',
    accentGradient: 'from-sky-400 via-blue-200 to-blue-600',
    foilGlow: 'rgba(56, 189, 248, 0.4)',
    shieldBorderGradient: 'from-[#38bdf8] via-[#bfdbfe] to-[#1d4ed8]',
    auraColor: 'rgba(56, 189, 248, 0.35)',
  },
